...
if __name__ == '__main__':
    ...
    Training
    '''
    # img_root = '/path/to//train/images'
    # label_root = '/path/to//train/annotations'
    # new_img_root = '/path/to//new_train/images'
    # new_label_json = '/path/to//new_train/label.json'
    # make_new_train_set(img_root, label_root, new_img_root, new_label_json)

    '''
    Validation
    '''
    # img_root = '/path/to//val/images'
    # label_root = '/path/to//val/annotations'
    # new_img_root = '/path/to//new_val/images'
    # new_label_json = '/path/to//new_val/label.json'
